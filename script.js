...
// (e) parameter is the event object
// e.target refers to the element that triggered the event: colorPicker
// e.target.value: This retrieves the current value of the color picker input
